# -*- coding: utf-8 -*-
#
# dbbc3 documentation build configuration file, created by
...
project = u'dbbc3'
copyright = u'2021, Helge Rottmann'
...
# documentation.
html_theme_options = {'body_max_width': '10%',}
...
latex_documents = [
  ('index', 'dbbc3.tex', u'dbbc3 Documentation',
   u'Helge Rottmann', 'manual'),
]
...
man_pages = [
    ('index', 'dbbc3', u'dbbc3 Documentation',
     [u'Helge Rottmann'], 1)
]
...
texinfo_documents = [
  ('index', 'dbbc3', u'dbbc3 Documentation',
   u'Helge Rottmann', 'dbbc3', 'One line description of project.',
   'Miscellaneous'),
]
